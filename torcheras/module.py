...
class Module(torch.nn.Module):
    ...
    def compile(self,
        ...
        self._multi_masks = multi_tasks or []
    ...
    def fit(self,
        ...
        for epoch in range(epochs):
            ...
            if test_dataloader:
                self.eval()
                test_metrics_averaged = self.evaluate(test_dataloader, batch_num=len(test_dataloader))

            # save ema
            if type(save_ema) == str:
                if save_ema == 'epoch':
